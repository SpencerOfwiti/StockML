...
# %% load datasets
test = pd.read_csv('../../data/predicted/auto_arima/Safaricom-Ltd(SCOM).csv')
...
plt.title('Safaricom Price Prediction (Auto-ARIMA)')
plt.legend()
plt.savefig('../../reports/figures/Safaricom_auto_arima.png')
plt.show()
