...
# %% load datasets
test = pd.read_csv('../../data/predicted/knn/Safaricom-Ltd(SCOM).csv')
...
plt.title('Safaricom Price Prediction (K-Nearest Neighbors)')
plt.legend()
plt.savefig('../../reports/figures/Safaricom_knn.png')
plt.show()
